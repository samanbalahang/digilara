                    ...
                    <section class="formTitle">
                        ...
                        <p>
                            @php
                                ...
                                $src  =  url('/')."/".$media->image_path;

                            @endphp
               
                            <img src="{{$src}}" alt="{{$banner->banner_name}}" class="w-100">
                        </p>
                    </section>
                    <form action="{{route('banner.update',$id)}}" method="post" enctype="multipart/form-data" id="bannerForm">
                        @csrf
