@section("sidebar")
<aside class="col-12 col-md-12 p-0 bg-black">
        ...
        <div class="pt-6">
            <ul class="nav nav-tabs mb-3" id="myTab0" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    ...
                    <ul class="absolute-menu submenu">
                        <li><a href="{{route('banner.index')}}">همه بنرها</a></li>
                        <li><a href="{{route('banner.create')}}">افزودن بنر</a></li>
                    </ul>
                </li>
                <li class="nav-item" role="presentation">
                    ...
                    <ul class="absolute-menu submenu">
                        <li><a href="{{route('media.index')}}">کتابخانه</a></li>
                        <li><a href="{{route('media.create')}}">افزودن</a></li>
                    </ul>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="profile-tab0" type="button" href="{{url('/')}}/lara-admin/posts">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="page-tab0" role="tab" type="button" href="{{route('pages.index')}}">
                        <i class="fas fa-file-alt fa-fw me-3"></i><span>برگه ها </span>
                    </a>
                    <ul class="absolute-menu submenu">
                        <li><a href="#">همه برگه ها</a></li>
                        <li><a href="#">افزودن جدید</a></li>
                        <li><a href="{{route('first-page.index')}}">صفحه اصلی</a></li>
                    </ul>
                </li>
                <li class="nav-item" role="presentation">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="form-tab0" role="tab" type="button" href="{{route('forms.index')}}">
